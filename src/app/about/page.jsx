    ...
    <div className="about-modal-inner">
      ...
      <div className="about-content">
        ...
        <div className="about-text">
          ...
          <p className="about-desc">
            I am a passionate and results-driven software developer dedicated to
            crafting exceptional user experiences and robust, scalable back-end
            systems.
          </p>
          ...
          <div className="subsection">
            ...
            <p className="subsection-desc">
              My fascination with technology began with building simple websites
              in high school. This hobby quickly evolved into a career-long
              commitment to mastering the full development life cycle. I thrive
              on the challenge of transforming complex ideas into elegant,
              functional code. With a background in computer science, I've spent
              the last {yearsOfExperience} years building and maintaining web
              applications for both startups and established companies, focusing
              ...
              <div className="info-item">
                ...
                <div>
                  ...
                  <p className="info-value">
                    B.S. in Computer Science from University of Port Harcourt
                  </p>
                </div>
              </div>
            </div>
            <div className="info-grid-right">
              ...
              <div className="info-item">
                ...
                <div>
                  ...
                  <a
                    href="https://x.com/anc13nt2?s=09"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="info-link"
                  >
      ...
      <div className="section-space">
        ...
        <div className="subsection">
          ...
          <p className="subsection-desc">
            I specialize in a modern, comprehensive toolkit that allows me to
            build applications efficiently. My primary stack revolves around{" "}
            <span className="info-link">Next.Js</span> for dynamic,
            ...
            <span className="info-link">MongoDB</span> for flexible data storage
            solutions. For development, I rely on tools like{" "}
            <span className="info-link">Git</span> for version control, Webpack
            for asset bundling, and <span className="info-link">Docker</span>{" "}
            for containerization to ensure a consistent development environment.
          </p>
        </div>
        ...
        <div className="community">
          <div className="subsection">
            ...
            <p className="subsection-desc">
              ...
              believe in continuous learning and collaboration, which is why I
              actively participate in tech events and conferences. I've had the
              pleasure of attending events like{" "}
              ...
              <span className="info-link">GoogleExtend</span> where I've met
              inspiring developers, product managers, and mentors. These
              connections have enriched my understanding of the industry and
              have led to exciting new opportunities.
            </p>

            <div className="photo-grid">
              {communityPhotos.map((photo) => (
                <div key={photo.id} className="photo-card photo-card-container">
                  <img
                    src={photo.imgUrl}
                    alt={photo.altText}
                    className="photo-img"
          ...
          <div className="subsection">
            ...
            <p className="subsection-desc">
              I am an active member of several vibrant tech communities. Here
              are some of the groups I'm proud to be a part of:
            </p>
